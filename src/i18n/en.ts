const en = {
  ...
  hint: 'Hint',
  hintIntro: 'Here is a clue!',

  newLevelUnlocked: 'New level unlocked!',
  allDone: 'You learned them all!',
  keepGoing: 'You can keep playing for fun!',
  ...
  empty: 'No countries here yet.',
  funFact: 'Fun fact',

  exit: 'Exit',
  exitConfirm: 'Stop playing this round?',
